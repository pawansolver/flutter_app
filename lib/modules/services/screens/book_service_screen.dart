          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'By ${item.providerName ?? 'Local Pro'} • ${item.categoryName ?? 'Service'}',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _buildSummaryRow('Provider', item.providerName ?? 'Local Pro'),
          const SizedBox(height: 8),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 8),
                      _buildSummaryRow('Provider', widget.listing.providerName ?? 'Local Pro'),
                      const SizedBox(height: 8),
                      _buildSummaryRow('Requested Date', '${_selectedDate.day} ${_getMonthName(_selectedDate.month)}, ${_selectedDate.year}'),
                      const SizedBox(height: 8),
                      _buildSummaryRow('Requested Time', _selectedSlot),
                      const SizedBox(height: 8),
